...
import { handleAddAnswer } from '../ques';
import { connect } from 'react-redux';

class AnsQues extends Component {
  state = {
    answer: '',
  };
  ...
  handleSubmit = () => {
    const { authenticatedUser, question } = this.props;
    const { answer } = this.state;
    this.props.dispatch(handleAddAnswer(authenticatedUser, question.id, answer));
  };
              ...
              <div className="content columns">
                ...
                <div className="column">
                  ...
                  <div className="is-pulled-left">
                    <button type="submit" className="button is-dark" onClick={this.handleSubmit}>
                      Submit
                    </button>
                  </div>
                </div>
...
export default connect()(AnsQues);
